...
void testBoard(istream &is, int board_id) {
    ...
    size_t white_cm = board.capturing_moves(true).size();
    ...
    size_t black_cm = board.capturing_moves(false).size();
    ...
    size_t white_ncm = board.non_capturing_moves(true).size();
    ...
    size_t black_ncm = board.non_capturing_moves(false).size();
